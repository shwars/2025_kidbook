...
- В науке 🧪 — учёные используют статистику для анализа экспериментов.  
...
Теперь ты попробуй сам! Запиши, сколько раз в день ты играешь, читаешь или гуляешь, и посчитай среднее количество! Это интересно! 😊
