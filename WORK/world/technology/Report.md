...
| Ибрагимов Роман Рифхатович         | ... | |
| Тюмин Данила Ярославович         | ... |  |
| Юнусов Рустам Кобилович         | ... | |
| Бонокин Данил Сергеевич            |     | | 
...
Для визуализации сначала мы использовали Mermaid. Но полученная схема интуитивно непонятна.

Первоначальная визуализация в Mermaid:
```mermaid
graph TD
...
Четыре группы имеют разные разные цвета. При этом самые важные понятия дополнительно выделили цветом: 
