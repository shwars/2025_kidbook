...
concepts = [
    "Загрязнение окружающей среды", "Сортировка отходов", "Энергосбережение", "Биоразнообразие", "Климатические изменения",
    "Возобновляемые источники энергии", "Экосистема", "Рециклинг", "Фотосинтез", "Заповедники",
    "Экоактивизм", "Устойчивое развитие", "Водные ресурсы", "Экологический след", "Традиции охраны природы"
]
...
llm = GigaChat(credentials=('MzM4YTRjM2UtOWY3OS00YTlmLWEwMjItMGE0NmMwY2IyZDVhOjQ2OWIyOGEwLTQ1ZGQtNDU5ZS1hZTY4LWFhMjkwZDFjYjNjYg=='), verify_ssl_certs=False, model='GigaChat-Max')

# Улучшенный промпт с эмодзи и понятными примерами
template = """
    Представь, что ты специалист по работе с детьми. Ты очень хорошо умеешь объяснять сложные темы простыми словами. Так же ты очень хорошо знаешь тему экологии и ее проблемы. 
    ...
    "Загрязнение окружающей среды", "Сортировка отходов", "Энергосбережение", "Биоразнообразие", "Климатические изменения","Возобновляемые источники энергии", "Экосистема", "Рециклинг", "Фотосинтез", "Заповедники","Экоактивизм", "Устойчивое развитие", "Водные ресурсы", "Экологический след", "Традиции охраны природы"
