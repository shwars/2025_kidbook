...
def send_message(access_token, label, topic, topics):
    ...
    prompt = (
        f'Привет, можешь объяснить на русском что такое "{label}". Вот тебе небольшой текст с английской википедии: "{topic}". '
        f'Перепеши его, будто объясняешь это для 10-летнего ребенка (на русском) и развей мысль. '
        f'Не пиши "Привет" и прочие вещи, просто выведи то, что я прошу. '
    )
